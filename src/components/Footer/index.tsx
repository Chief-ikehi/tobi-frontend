      ...
      <footer className="border-t border-stroke bg-white  dark:border-strokedark dark:bg-blacksection">
        <div className="mx-auto max-w-c-1390 px-4 md:px-8 2xl:px-0">
              ...
              >
                <Link href="/" className="relative">
                  <Image
                    ...
                    alt="Logo"
                    className="dark:hidden transition-transform duration-300 ease-in-out hover:scale-110"
                  />
                  <Image
                    width={110}
                    height={80}
          ...
          <div className="flex flex-col flex-wrap items-center justify-center gap-5 border-t border-stroke py-7 dark:border-strokedark lg:flex-row lg:justify-between lg:gap-0">
            ...
            >
              <p>
                &copy; {new Date().getFullYear()} TOBI. All rights reserved
              </p>
            </motion.div>
                  ...
                  <a href="#" aria-label="social icon">
                    ...
                    >
                      <g clipPath="url(#clip0_48_1508)">
                        <path d="M25.6,8c2.9,0,3.5,0,5,0.1c1.7,0.1,2.9,0.3,3.9,0.7c1.1,0.4,1.9,1,2.8,1.8s1.4,1.8,1.8,2.8

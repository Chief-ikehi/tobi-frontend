      ...
      <section className="relative h-[80vh] min-h-[600px] w-full">
        ...
        <div className="absolute inset-0 bg-black/50">
          <div className="container mx-auto flex h-full flex-col items-center justify-center px-4 text-center text-white">
            ...
            >
              Welcome to the Exclusive Private Members Program
            </motion.h1>
            <motion.p
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              Luxury, Convenience, and Priority Access Awaits You
            </motion.p>
            <motion.button
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.6, delay: 0.4 }}
              className="rounded-full bg-primary px-8 py-4 text-lg font-semibold text-white transition-all hover:bg-primary/90"
            >
              Join Now
            </motion.button>
          </div>
...
export default PrivateMembersLanding; 